...
public class Constants
{
    ...
    public static class Pose
    {
        ...
        public static final Pose2d START = new Pose2d(Units.feetToMeters(10 + ROBOT_LENGTH / 2.0), Units.feetToMeters(94.66 / 12.0), new Rotation2d(Units.degreesToRadians(180)));
        ...
        public static final Pose2d RENDEZVOUS_POINT_BALL_1 = new Pose2d(
            ...
            new Rotation2d(Units.degreesToRadians(-67.5))
        );
