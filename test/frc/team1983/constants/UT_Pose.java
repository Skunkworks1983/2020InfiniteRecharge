...
public class UT_Pose
{
    ...
    public void printPoses()
    {
        ...
        System.out.println("RENDEZVOUS_POINT_BALL_3: " + Constants.Pose.RENDEZVOUS_BALL_3 + ", " + Constants.Pose.RENDEZVOUS_BALL_3.getRotation().getCos() + ", " + Constants.Pose.RENDEZVOUS_BALL_3.getRotation().getSin());
        System.out.println("RENDEZVOUS_POINT_BALL_1_AND_2_AND_3: " + Constants.Pose.RENDEZVOUS_BALL_1_AND_2_AND_3 + ", " + Constants.Pose.RENDEZVOUS_BALL_1_AND_2_AND_3.getRotation().getCos() + ", " + Constants.Pose.RENDEZVOUS_BALL_1_AND_2_AND_3.getRotation().getSin());
        System.out.println("RENDEZVOUS_POINT_BALL_4: " + Constants.Pose.RENDEZVOUS_BALL_4 + ", " + Constants.Pose.RENDEZVOUS_BALL_4.getRotation().getCos() + ", " + Constants.Pose.RENDEZVOUS_BALL_4.getRotation().getSin());
        System.out.println("RENDEZVOUS_POINT_BALL_5: " + Constants.Pose.RENDEZVOUS_BALL_5 + ", " + Constants.Pose.RENDEZVOUS_BALL_5.getRotation().getCos() + ", " + Constants.Pose.RENDEZVOUS_BALL_5.getRotation().getSin());
